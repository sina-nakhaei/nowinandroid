...
import com.google.samples.apps.nowinandroid.core.network.retrofit.RetrofitNewsNetwork
import dagger.Binds
...
internal interface FlavoredNetworkModule {
    ...
    @Binds
    fun bindsNewsNetwork(impl: RetrofitNewsNetwork): NewsNetworkDataSource
}
